...
4::SendInput, {#}region 변수{Enter}{#}endregion{Enter}{End}{Enter}{#}region 프로퍼티{Enter}{#}endregion{Enter}{End}{Enter}{#}region 생성자{Enter}{#}endregion{Enter}{End}{Enter}{#}region 메소드{Enter}{#}endregion
...
m & 3::SendInput, <img src="/uploads/dc712a322c1d6bf96c75a53eb01232ec/image.png" width="350">{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}{Left}
