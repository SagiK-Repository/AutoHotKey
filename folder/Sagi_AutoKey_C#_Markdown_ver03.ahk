...
4::SendInput, {#}region 변수{Enter}{#}endregion{Enter}{Enter}{Enter}{#}region 프로퍼티{Enter}{#}endregion{Enter}{Enter}{Enter}{#}region 생성자{Enter}{#}endregion{Enter}{Enter}{Enter}{#}region 메소드{Enter}{#}endregion
